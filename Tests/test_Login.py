...
class TestLogin(BaseTest):
    ...
    def test_vertify_invalid_email(self):
        ...
        lp.click_login()
        assert "Please include an '@' in the email address. 'invalid_email' is missing an '@'." in lp.get_email_validtied("validationMessage")
        print(lp.get_email_validtied("validationMessage"))
